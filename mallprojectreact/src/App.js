...
//Material-UI
import { Menu,MenuItem,IconButton,Avatar,Button } from "@material-ui/core";
          ...
          <Navbar bg="dark" variant="dark" expand="lg" >
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              ...
              {Auth.isLoggedIn()
               ? 
               <React.Fragment>
                <div style={{paddingRight:25,marginTop:"auto",marginBottom:"auto"}}>
                ...
                >
                  <Avatar fontSize="large" alt="Remy Sharp" src={`/profileImages/${Auth.username()}.png`} />
               </IconButton>
             </React.Fragment>
              :
                <IconButton
